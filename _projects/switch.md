...
contributors:
    - Matteo Salani
    - Gianpiero Mattei (ISTEPS - SUPSI)

partners:
    - LIUC – Università Cattaneo (coordinator italian side)
    - SUPSI – Scuola universitaria professionale della Svizzera italiana (coordinator swiss side)
    - Fondazione Links
